...
def extract_random_clip_from_video(video_url, video_duration, clip_duration, output_file, start_time=None):
    ...
    Args:
        ...
        start_time (int, optional): The start time of the clip in seconds. If not provided, a random start time is selected.
    """
    ...
    # Use provided start_time or generate a random one
