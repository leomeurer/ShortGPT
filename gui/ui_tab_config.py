        ...
        with gr.Tab("Config") as config_ui:
            with gr.Row():
                with gr.Column():
                    ...
                    with gr.Row():
                        groq_textbox = gr.Textbox(value=self.api_key_manager.get_api_key("GROQ_API_KEY"), label=f"GROQ API KEY", show_label=True, interactive=True, show_copy_button=True, type="password", scale=40)
